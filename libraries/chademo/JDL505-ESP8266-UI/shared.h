...
enum command_type {
	...
	CMD_VOLTAGE, CMD_CURRENT, CMD_AMPHOURS, CMD_POWER, CMD_KWH, CMD_SOC, CMD_UPDATE_STATUS, CMD_TIME_REMAINING, CMD_EMULATE_CHARGER, CMD_SET_CHARGE_TIME, CMD_LIMIT_CHARGE_CURRENT_BY_BMS,
	CMD_MAX_INPUT_POWER,
